...
{ "hppa*-*-*elf*", NULL },{ "hppa*-*-linux-gnu*", NULL },{ "hppa*-*-lites*", NULL },{ "hppa*-*-sysv4*", NULL },{ "hppa*-*-rtems*",
&bfd_elf32_hppa_vec },
#endif
...
{ "mips*el-*-elf*", NULL },{ "mips*el-*-rtems*", NULL },{ "mips*el-*-vxworks*",
&bfd_elf32_littlemips_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_ss_coff_big_vec)
...
#if !defined (SELECT_VECS) || defined (HAVE_ss_coff_little_vec)
